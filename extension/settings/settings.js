...
function setupEventListeners() {
  ...
  testTtsButton.addEventListener('click', () => {
    ...
    if (voiceURI) {
      ...
      TTSUtils.setText('This is a test of the text-to-speech feature in WebPage Chatter.');
      TTSUtils.play();
    } else {
...
async function saveSettings() {
  try {
    ...
    // Get other settings
    const apiEndpoint = apiEndpointInput.value.trim() || 'http://localhost:8000/api/chat';
